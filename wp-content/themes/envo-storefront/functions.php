...
if (!function_exists('envo_storefront_generate_construct_footer')) :
    ...
    function envo_storefront_generate_construct_footer() {
        ...
        <div class="footer-credits-text text-center">
            ...
            printf(esc_html__('Proudly powered by %s', 'envo-storefront'), '<a href="' . esc_url(__('https://slicegroup.xyz/', 'envo-storefront')) . '">' . esc_html__('Slice Group', 'envo-storefront') . '</a>');
            ?>
            <span class="sep"> | </span>
            <?php
            /* translators: %1$s: Envo Storefront theme name (do not translate) with envothemes.com URL */
            printf(esc_html__('Grupo ROGA CA @Copyright 2020. Todos los derechos reservados', 'envo-storefront'), '<a href="' . esc_url('https://envothemes.com/free-envo-storefront/') . '">' . esc_html_x('Envo Storefront', 'Theme name, do not translate', 'envo-storefront') . '</a>');
            ?> 
        </div> 
        <?php
    }
