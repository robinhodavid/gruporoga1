...
<div id="reviews" class="woocommerce-Reviews">
	<div id="comments">
		...
		$woohoo_reviews_tab_heading = get_option( 'woohoo_reviews_tab_heading' );

		if ( $woohoo_reviews_tab_heading === 'yes' ) : ?>

		<h2 class="woocommerce-Reviews-title"><?php

			$woohoo_reviews_tab_heading_text = get_option( 'woohoo_reviews_tab_heading_text' );

			if ( ! empty( $woohoo_reviews_tab_heading_text ) ) :

				echo $woohoo_reviews_tab_heading_text;
