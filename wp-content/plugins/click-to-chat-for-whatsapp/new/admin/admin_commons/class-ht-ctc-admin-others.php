...
class HT_CTC_Admin_Others {
    ...
    function ifgroupblank() {
        ?>
        <div class="notice notice-info is-dismissible">
            <p>Click to Chat is almost ready. <a href="<?php echo admin_url('admin.php?page=click-to-chat-group-feature');?>">Add WhatsApp Group ID</a> to let visitors join in your WhatsApp Group.</p>
            <!-- <a href="?dismis">Dismiss</a> -->
        </div>
        <?php
    }
