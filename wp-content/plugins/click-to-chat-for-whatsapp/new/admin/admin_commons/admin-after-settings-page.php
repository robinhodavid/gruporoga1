...
<ul class="collapsible popout">
    ...
    <li>
    <div class="collapsible-header">Change Values(number) at page level</div>
    <div class="collapsible-body">
        <p class="description">We can <a target="_blank" href="https://holithemes.com/plugins/click-to-chat/change-values-at-page-level/">change the WhatsApp number, Call to Action</a> while editing the post from the right side bar</p>
    </div>
    </li>
    ...
    <li>
    <div class="collapsible-header">No WhatsApp Number Found!</div>
    <div class="collapsible-body">
        <p class="description">Add <a href="#chat_settings">WhatsApp Number with Country Code</a></p>
        <p class="description">If already added it might be cached version, <strong>Clear the Cache and try</strong></p>
        <p class="description">If still an issue, please contact us</p>
    </div>
    </li>
