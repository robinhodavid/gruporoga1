...
class HT_CTC_Admin_Share_Page {
    ...
    public function settings() {
        ...
        add_settings_field( 'share_ctc_desktop', 'Desktop', array( $this, 'share_ctc_desktop_cb' ), 'ht_ctc_share_page_settings_sections_do', 'ht_ctc_main_page_settings_sections_add' );
        add_settings_field( 'share_ctc_mobile', 'Mobile', array( $this, 'share_ctc_mobile_cb' ), 'ht_ctc_share_page_settings_sections_do', 'ht_ctc_main_page_settings_sections_add' );
