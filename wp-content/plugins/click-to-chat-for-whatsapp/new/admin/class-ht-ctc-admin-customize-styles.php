...
class HT_CTC_Admin_Customize_Styles {
    ...
    function ht_ctc_s3_cb() {
        ...
        <div class="row">
            ...
            <div class="input-field col s6">
                ...
                <label for="s3_img_size">Image Size (Default: 50px )</label>
            </div>
        </div>
        ...
        <div class="s3_type_extend" style="<?php echo $s3_extend_display ?>">
            ...
            <div class="row">
                ...
                <div class="input-field col s6">
                    ...
                    <label for="s3_padding">Padding (Default: 20px )</label>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="input-field col s6">
                    ...
                    <p class="description">E.g. Colors: #25D366, #20b038 </p>
                </div>
            </div>
            <?php
    ...
    function ht_ctc_s4_cb() {
        ...
        <div class="row">
            ...
            <div class="input-field col s6">
                ...
                <label for="s4_img_url">Image URL(leave blank for default image)</label>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="input-field col s6">
                ...
                <label for="s4_img_size">Image Size (default 32px)</label>
                <p class="description">(possible, keep the value less then or equal to 32px)</p>
            </div>
        </div>
    ...
    function ht_ctc_othersettings_cb() {
        ...
        if ( isset( $options['select_styles_issue'] ) ) {
            ...
            <p id="styles_issue">
                <label>
                    ...
                    <span>Check this only, If styles for mobile, desktop not selected as expected(due to cache)</span>
                </label>
            </p>
            <?php
        } else {
        ...
        ?>
            <p class="description">  - <a target="_blank" href="https://holithemes.com/plugins/click-to-chat/select-styles/">more info</a> </p>
        <br>
        <?php
        ...
        <!-- chat -->
        <p class="description">Chat settings are enabled by default and can't disbale. If like to hide chat on all pages select <a target="_blank" href="<?php echo admin_url( 'admin.php?page=click-to-chat#showhide_settings' ); ?>">show on selected pages</a> </p>
        <p class="description"> - <a target="_blank" href="<?php echo admin_url( 'admin.php?page=click-to-chat' ); ?>">Chat Settings page</a> <br> - <a target="_blank" href="https://www.holithemes.com/plugins/click-to-chat/enable-chat">more info</a> </p>
        </p>
        <br>
        ...
        if ( isset( $options['fb_analytics'] ) ) {
            ...
            ?>
            <p class="description"> This feature is <b>depreacted</b> in the favor of Facebook Pixel</p>
